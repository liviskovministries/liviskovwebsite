  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-start p-4 overflow-hidden">
      ...
      <main className="relative z-20 flex flex-col items-center justify-start h-full w-full max-w-md md:max-w-5xl mx-auto text-center space-y-6 md:space-y-16 pt-10">
        ...
        {/* Descrição fora do card, com estilo criativo */}
        <div className="w-full max-w-4xl bg-white/80 backdrop-blur-sm rounded-xl p-6 md:p-8 shadow-lg border border-custom-green/30 text-custom-green">
          <p className="text-base font-clear-sans leading-relaxed text-justify">
